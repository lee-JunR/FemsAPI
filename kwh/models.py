...
class FemsPayload(models.Model):
    ...
    site = models.ForeignKey('FemsTrans', models.DO_NOTHING)
    dev = models.ForeignKey('FemsTrans', models.DO_NOTHING)
    dev_time = models.ForeignKey('FemsTrans', models.DO_NOTHING, db_column='dev_time')
